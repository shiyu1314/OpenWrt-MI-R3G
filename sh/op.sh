...
git_sparse_clone master https://github.com/openwrt/openwrt target/linux/ramips
git_sparse_clone master https://github.com/openwrt/openwrt toolchain/kernel-headers
git_sparse_clone main https://github.com/openwrt/openwrt target/linux/generic
...
cp -rf generic target/linux
cp -rf kernel-headers toolchain
cp -rf ramips target/linux
...
curl -s https://raw.githubusercontent.com/sbwml/r4s_build_script/openwrt-23.05/openwrt/patch/mt76/Makefile > package/kernel/mt76/Makefile
